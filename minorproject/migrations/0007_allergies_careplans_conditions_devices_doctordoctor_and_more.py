...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('minorproject', '0006_delete_allergies_delete_careplans_delete_conditions_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.FloatField(blank=True, db_column='CODE', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.FloatField(blank=True, db_column='CODE', null=True)),
                ('description', models.TextField(blank=True, db_column='DESCRIPTION', null=True)),
                ('reasoncode', models.FloatField(blank=True, db_column='REASONCODE', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.FloatField(blank=True, db_column='CODE', null=True)),
                ('description', models.TextField(blank=True, db_column='DESCRIPTION', null=True)),
                ('base_encounter_cost', models.FloatField(blank=True, db_column='BASE_ENCOUNTER_COST', null=True)),
                ('total_claim_cost', models.FloatField(blank=True, db_column='TOTAL_CLAIM_COST', null=True)),
                ('payer_coverage', models.FloatField(blank=True, db_column='PAYER_COVERAGE', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.TextField(blank=True, db_column='PATIENT', null=True)),
                ('encounter', models.TextField(blank=True, db_column='ENCOUNTER', null=True)),
                ('bodysite_code', models.FloatField(blank=True, db_column='BODYSITE_CODE', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_cost', models.FloatField(blank=True, db_column='BASE_COST', null=True)),
                ('payer_coverage', models.FloatField(blank=True, db_column='PAYER_COVERAGE', null=True)),
                ('dispenses', models.FloatField(blank=True, db_column='DISPENSES', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zip', models.FloatField(blank=True, db_column='ZIP', null=True)),
                ('phone', models.TextField(blank=True, db_column='PHONE', null=True)),
                ('amount_covered', models.FloatField(blank=True, db_column='AMOUNT_COVERED', null=True)),
                ('amount_uncovered', models.FloatField(blank=True, db_column='AMOUNT_UNCOVERED', null=True)),
                ('revenue', models.FloatField(blank=True, db_column='REVENUE', null=True)),
                ('covered_encounters', models.FloatField(blank=True, db_column='COVERED_ENCOUNTERS', null=True)),
                ('uncovered_encounters', models.FloatField(blank=True, db_column='UNCOVERED_ENCOUNTERS', null=True)),
                ('covered_medications', models.FloatField(blank=True, db_column='COVERED_MEDICATIONS', null=True)),
                ('uncovered_medications', models.FloatField(blank=True, db_column='UNCOVERED_MEDICATIONS', null=True)),
                ('covered_procedures', models.FloatField(blank=True, db_column='COVERED_PROCEDURES', null=True)),
                ('uncovered_procedures', models.FloatField(blank=True, db_column='UNCOVERED_PROCEDURES', null=True)),
                ('covered_immunizations', models.FloatField(blank=True, db_column='COVERED_IMMUNIZATIONS', null=True)),
                ('uncovered_immunizations', models.FloatField(blank=True, db_column='UNCOVERED_IMMUNIZATIONS', null=True)),
                ('unique_customers', models.FloatField(blank=True, db_column='UNIQUE_CUSTOMERS', null=True)),
                ('qols_avg', models.FloatField(blank=True, db_column='QOLS_AVG', null=True)),
                ('member_months', models.FloatField(blank=True, db_column='MEMBER_MONTHS', null=True)),
            ],
            options={
                'db_table': '`payers`',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('patient', models.TextField(blank=True, db_column='PATIENT', null=True)),
                ('start_year', models.FloatField(blank=True, db_column='START_YEAR', null=True)),
                ('end_year', models.FloatField(blank=True, db_column='END_YEAR', null=True)),
                ('payer', models.TextField(blank=True, db_column='PAYER', null=True)),
